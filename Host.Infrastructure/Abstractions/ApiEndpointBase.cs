using Host.Infrastructure.HttpResults;
    ...
    : IApiEndpoint
{
    ...
    void IApiEndpoint.MapEndpoint(IEndpointRouteBuilder builder)
    {
    ...
    public abstract IApiEndpointHandler<TRequest, TResponse> Handler { get; }
    ...
    private static IResult JsonOk<TValue>(TValue? value)
        => value is null ? TypedResults.Ok() : new JsonOkResult<TValue>(value);
}